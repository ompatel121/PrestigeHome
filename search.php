...
<div class="super_container">
    ...
    $select = mysqli_query($con,"select * from Properties where status='A' AND property_for='".$_GET['pfor']."' AND type='".$_GET['type']."' AND district='".$_GET['district']."' AND city='".$_GET['city']."' AND bedroom='".$_GET['bedroom']."'");
    ?>
	<!-- Properties -->
